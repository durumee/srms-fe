...
function createTestData() {
  return [
    // 1단계: 최상위 요구사항 - 2025년도 사업
    {
      REQRM_ID: 10,
      UPPER_REQRM_ID: null,
      REQRM_NM: '2025년도 사업',
      REQRM_DC: '2025년 서비스 개선 및 신규 기능 도입을 위한 전반적인 요구사항',
      SORT_ORDR: 1,
      DEL_AT: 'N',
    },

    // 2단계: '2025년도 사업'(10)의 하위 요구사항 (기존의 최상위 항목들)
    {
      REQRM_ID: 100,
      UPPER_REQRM_ID: 10,
      REQRM_NM: '사용자 관리',
    ...
    // 3단계: 기존의 2단계 항목들 (UPPER_REQRM_ID가 100, 200, 300으로 변경됨)
    {
      REQRM_ID: 101,
      UPPER_REQRM_ID: 100,
      REQRM_NM: '회원가입',
    ...
    // 4단계: 기존의 3단계 항목들 (UPPER_REQRM_ID가 101, 102, 201 등으로 변경됨)
    {
      REQRM_ID: 1011,
      UPPER_REQRM_ID: 101,
      REQRM_NM: '필수 정보 입력',
